(function ($) {
    ...
    Citys[22] = new Array("广西", "南宁|柳州|桂林|梧州|北海|防城港|钦州|贵港|玉林|南宁|来宾|贺州|百色|河池");
    ...
    $.fn.cities = function (options) {
        ...
        this.each(function () {
            var str = "<select class=\"userslecet\" name=\"" + options.p_name + "\" id=\"" + options.p_name + "\" style=\"width:" + options.p_width + "px;\" >";
            str += "<option value=\"\">选择省份</option></select>";
            str += " ";
            str += "<select class=\"userslecet\" name=\"" + options.c_name + "\" id=\"" + options.c_name + "\" style=\"width:" + options.c_width + "px;\" >";
            str += "<option value=\"\">选择市/县</option></select>";
            $(this).html(str);
